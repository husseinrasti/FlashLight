...
/*
 * Copyright 2013 Piotr Adamus Licensed under the Apache License, Version 2.0
...
public class ColorPicker extends View {
     ...
     */
    private final int paramOuterPadding     = 2;                           // outer
// padding of the whole color picker view
    private final int paramInnerPadding     = 5;                           // distance
// between value slider wheel and inner color wheel
    private final int paramValueSliderWidth = 10;                          // width
// of the value slider
    private final int paramArrowPointerSize = 4;                           // size
// of the arrow pointer; set to 0 to hide the pointer
	...
	SweepGradient sweepGradient = new SweepGradient( centerX , centerY , new int[] {
	        Color.BLACK , Color.HSVToColor( hsv ) , Color.WHITE } , null );
